...
SpAddonsConfig::addonConfig(
	array( 
		...
		'attr'=>array(
			...
			'bullets'=>array(
				'type'=>'select', 
				'title'=>JText::_('Show Bullets'),
				'desc'=>JText::_('Show or hide testimonial slider bullets.'),
				'values'=>array(
					1=>JText::_('JYES'),
					0=>JText::_('JNO'),
					),
			...
			'repetable_item'=>array(
				...
				'attr'=>  array(
					...
					'designation'=>array(
						'type'=>'text', 
						'title'=>JText::_('Client Designation '),
						'desc'=>JText::_('Enter the designation of the client.'),
						'std'=>'CEO',
						),
					'avatar'=>array(
						'type'=>'media', 
