												...
												<?php /*Date type blog*/ if ($article_date_format=='blog'): ?>
													<div class="ns2-date-blog">
														<?php
															...
															echo '<div class="ns2_date_month_year"><span class="ns2_date_month">' . $date_time[1] . '</span></div>';
														?>
													</div>
												<?php endif; ?>												
													...
													<div class="ns2-tools">
														...
														<?php /*Show date*/ if (($article_date_format) && ($article_date_format!='blog')): ?>
															<div class="ns2-created">
																...
																<?php endif; ?>
																<?php echo JHTML::_('date', $list[$i]->created, date("d M")); ?>
															</div>
														<?php endif; ?>
													</div>
												<?php endif; ?>
										...
										<div style="padding:<?php echo $links_col_padding ?>">
											<div class="ns2-inner">
												...
												<div class="news-container">
													...
													<div class="ns2-link-date">
														<?php
															$date_time = explode(' ', JHTML::_('date', $list[$i]->created, 'd M Y'));
															echo '<span class="">' . $date_time[0] . '&amp;' . $date_time[1] . '&amp;' . $date_time[2] . '</span>';
