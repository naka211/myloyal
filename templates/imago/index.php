...
<head>
    ...
    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css, animate.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, smooth-scroll.js, jquery.nav.js, main.js') // JS Files
...
<body class="<?php echo $this->helix3->bodyClass( $body_classes ); ?> <?php echo $pageclass ? htmlspecialchars($pageclass) : 'default'; ?>">
