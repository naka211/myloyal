...
<!--                        <div class="form-group">
		...
		<h2 class="title"><?php echo JText::_('COM_USERS_REGISTER_TITLE_REGISTER3')?></h2>
                ...
                <div class="checkbox">
                    <label>
                        <input onclick='registercheck(this);' style="width:5% !important;" required="required" type="checkbox" value="" id="checkboxRegister">
                        <a style="line-height: 40px;" class="underline" href="<?php echo JUri::base().'index.php?option=com_content&view=article&id=31'?>">
                            Jeg har læst og accepterer betingelser</a>
                    </label>
                </div>
                <div class="control-group">
                    <div class="">
                        <button type="submit" onclick="" id="register" class="btn validate btnPayment"><?php echo JText::_('JREGISTER');?></button>
                        <!--<button type="submit" onclick="" id="register" style="display:none;" class="btn validate btnPayment"><?php echo JText::_('JREGISTER');?></button>-->
