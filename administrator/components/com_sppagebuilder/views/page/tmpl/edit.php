...
var html = '';
    ...
    html += '<a class="add-column" href="javascript:void(0)"><i class="fa fa-plus"></i> <?php echo JText::_("COM_SPPAGEBUILDER_ADD_COLUMN"); ?></a>';
    html += '<ul>';
    ...
    html += '</ul>';
    html += '</div>';
    html += '<a class="copy-row" href="javascript:void(0)"><i class="fa fa-copy"></i> <?php echo JText::_("COM_SPPAGEBUILDER_COPY"); ?></a> ';
    html += '<a class="paste-row" href="javascript:void(0)"><i class="fa fa-paste"></i> <?php echo JText::_("COM_SPPAGEBUILDER_PASTE"); ?></a>';
    html += '</div>';

    html += '<div class="row-actions pull-right">';
    html += '<a class="add-rowplus sp-tooltip" href="javascript:void(0)" data-toggle="tooltip" data-original-title="<?php echo JText::_("COM_SPPAGEBUILDER_ADD_NEW_ROW"); ?>"><i class="fa fa-plus"></i></a>';
    html += '<a class="row-options sp-tooltip" href="javascript:void(0)" data-toggle="tooltip" data-original-title="<?php echo JText::_("COM_SPPAGEBUILDER_ROW_SETTINGS"); ?>"><i class="fa fa-cog"></i></a>';
    html += '<a class="duplicate-row sp-tooltip" href="javascript:void(0)" data-toggle="tooltip" data-original-title="<?php echo JText::_("COM_SPPAGEBUILDER_CLONE_ROW"); ?>"><i class="fa fa-files-o"></i></a>';
    html += '<a class="disable-row sp-tooltip" href="javascript:void(0)" data-toggle="tooltip" data-original-title="<?php echo JText::_("COM_SPPAGEBUILDER_DISABLE_ROW"); ?>"><i class="fa fa-eye-slash"></i></a>';
    html += '<a class="delete-row sp-tooltip" href="javascript:void(0)" data-toggle="tooltip" data-original-title="<?php echo JText::_("COM_SPPAGEBUILDER_DELETE_ROW"); ?>"><i class="fa fa-times"></i></a>';
    html += '</div>';
    html += '</div>';
    ...
    html += '<a class="add-addon" href="javascript:void(0)"><i class="fa fa-plus-circle"></i> <?php echo JText::_("COM_SPPAGEBUILDER_ADDON"); ?></a>';
    html += '<a class="column-options" href="javascript:void(0)"><i class="fa fa-cog"></i> <?php echo JText::_("COM_SPPAGEBUILDER_OPTIONS"); ?></a>';
    html += '</div>';
    html += '</div>';
    html += '</div>';
    html += '</div>';
...
<form action="<?php echo JRoute::_('index.php?option=com_sppagebuilder&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
    ...
    <div class="pagebuilder-beta clearfix" style="margin: 30px auto; text-align: center;">
        <p><a href="http://www.joomshaper.com/page-builder/" target="_blank">SP Page Builder Pro v1.0.5</a> | Copyright &copy; 2010-2015 <a href="http://www.joomshaper.com" target="_blank">JoomShaper</a></p>
    </div>
