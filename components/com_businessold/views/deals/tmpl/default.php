                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo JRoute::_("index.php?option=com_business&view=deals&layout=edit&id=").$deals['id']?>" class="btn btnEdit">Rediger</a></td>
                                    </tr>
                                    <?php
                                    }?>
...
<!--                                                    <button class="btn btnCreatecampaign" type="submit">Create promotion</button>
                                            ...
                                            <div onclick="alert('Du har allerede brugt dine 2 tilbud i denne måned!')" class="btn btnCreatecampaign">OPRET TILBUD</div>
                                            <?php }else{?>
