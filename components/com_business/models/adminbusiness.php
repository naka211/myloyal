...
//		return $data;
        ...
        public function getBusiness()
	{
            ...
            if (isset($this->data))
            {
                    ...
                    ->where($db->quoteName('a.id') . ' = ' . $businessId);
        ...
        public function updateBusiness($business)
        {
            ...
            $object->timeExpired = $business['timeExpired'];
            if(isset($business['pointDescription']))
            {
                $object->pointDescription = $business['pointDescription'];
            }
        ...
        public function updateUserinfo($userinfo)
        {
            ...
            {
                $object->password = $userinfo['password'];
            }
