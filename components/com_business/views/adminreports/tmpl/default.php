            ...
            <div class="content">
                <section class="main-title">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title"><i class="fa fa-home"></i> Statistikker</h2>
                            </div>
                        </div>
                    </div>
                </section>
...
<script>
    function loadReport()
    {
        ...
        if(toTime > toDate)
        {
            alert("Det er ikke muligt at vise statistik for fremtiden.");
        }
        else
        {
            if(fromTime >= toTime)
            {
                alert("Din valgte kombination er ikke mulig.");
            }
            else
            {
                window.location = "<?php echo JRoute::_("index.php?option=com_business&view=adminreports")?>" + '&fromTime=' + fromTime + "&toTime=" + toTime + "&businessId=" + <?php echo $this->infomation['id']?>;
            }
        }
    }
</script>
...
Morris.Line({
  ...
  xkey: 'm',
  ykeys: ['a'],
  labels: ['<?php echo date('Y',  time())?>', '<?php echo date('Y',  time())?>'],
  resize: true,
