                    ...
                    <div class="container">
                        <div class="business-setting mt50">
                            <h2 class="text-center">Your action was failed . We are sorry about that.</h2>
                                ...
                                <a style="width: 40% ; margin-left: 30%;margin-right: 30%;" href="<?php echo JRoute::_("index.php?option=com_business&view=admincustomers&businessId=".$this->data['id'])?>" class="btn btnCreatecampaign">Click here to go to old page.</a>
