                    ...
                    <div class="container">
                        <div class="list-customer">
                            ...
                            <ul>
                                ...
                                ?>
                                <li>
                                    <a href="<?php echo JRoute::_("index.php?option=com_business&view=admincustomers&layout=view&customerid={$customer['id']}&businessId={$this->data['id']}")?>">
                                        <div class="row">
                                            <div class="col-md-6">
...
<!--                            <ul style="margin-top: 0;" class="pagination pull-right">
                                ...
                                <li <?php echo ($page == $i)?"class='active'":""?>><a href="<?php echo JRoute::_("index.php?option=com_business&view=admincustomers&businessId=".$businessId."&page=").$i?>" ><?php echo $i ?></a></li>
                                <?php }?>
