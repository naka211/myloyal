                    ...
                    <div class="container-fluid">
                        <div class="myloyalty-programs">
                            ...
                            <div class="frm-promotions">
                                <form class="frm-business-setting" id="contact-form" action="<?php echo JRoute::_('index.php?option=com_business&task=admindeals.newDeals'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="task" value="admindeals.newDeals" />
                                </form>
                            </div>
                        </div>
                    </div>
