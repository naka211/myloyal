                ...
                <section class="main-content">
                    <div class="container">
                        <div class="business-setting mt50">
                            <h2 class="text-center">Action Fail.</h2>
                            
                                <a style="width: 40% ; margin-left: 30%;margin-right: 30%;" href="<?php echo JRoute::_("index.php?option=com_business&view=adminselectbusiness")?>" class="btn btnCreatecampaign">Klik her for at gå tilbage</a>
