            ...
            <div class="content">
                <section class="main-title">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title"><i class="fa fa-cog"></i> Indstillinger</h2>
                            </div>
                        </div>
                    </div>
                </section>
                                ...
                                <form class="frm-business-setting" id="contact-form" action="<?php echo JRoute::_('index.php?option=com_business&task=adminbusiness.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php if($this->data['type'] == "1"){?>
                                            <div class="form-group">
                                            <label for=""><?php echo $this->listName["pointDescription"]?></label>
                                            <input name="<?php echo "jform[pointDescription]";?>" value="<?php echo $this->data['pointDescription'] ;?>" class="form-control" type="text">
                                            </div>
                                            <?php
                                            }
                                            ?>
                                            <div class="form-group">
                                            <label for=""><?php echo $this->listName["password"]?></label>
                                            <input name="<?php echo "jform[password]";?>" class="form-control" type="password">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            <label for=""><?php echo $this->listName["timeExpired"]?></label>
                                            <input id="jform_time_expired" readonly name="<?php echo "jform[time_expired]";?>" value="<?php echo date('d/m/Y',($this->data['timeExpired'] != '')?$this->data['timeExpired']:time()) ;?>" class="form-control date_input" type="text">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            <label for=""><?php echo $this->listName["address"]?></label> <span style="color:#828282;">(Husk du skal vælge en foreslået adresse i dropdown)</span>
                                            ...
                                            <div class="form-group">
                                            <label for="">Forretning-ID:</label>
                                            <input id="jform_newId" name="<?php echo "jform[newId]";?>" value="<?php echo $this->userinfo['newId'] ;?>" class="form-control" type="text" readonly>
                                            </div>
											
											<div class="form-group">
                                            <label for="">Abonnement Udløber:</label>
                                            <input id="jform_timeExpired" name="<?php echo "jform[timeExpired]";?>" value="<?php echo date("d/m/Y", $this->data['timeExpired']) ;?>" class="form-control" type="text" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
