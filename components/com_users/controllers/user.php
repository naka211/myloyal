...
//                                $app->redirect(JRoute::_('index.php?option=com_users&view=login', 'Du har ikke tilladelse til at logge ind på denne side. Denne side er kun beregnet til erhvervskonti.', 'error'));
                                $app->redirect(JUri::base() . "index.php?option=com_business&view=paymentaccount&layout=fail1");
