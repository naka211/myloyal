...
class UsersControllerRegistration extends UsersController
{
	...
	public function register()
	{
		...
		$session->set( 'email_login', $requestData['email'] );
		$session->set( 'password_login', $requestData['password1'] );
		//T.Trung end
		...
		$data	= $model->validate($form, $requestData);
                ...
                $data_business['businessEmail'] = $requestData ['email'];
				...
				$data_business['referencer'] = $requestData ['referencer'];
//                $data_business['type'] = $requestData ['business_type'];
	...
	public function setType(){
		...
		$password = $session->get( 'password_login', '' );
		print_r($email."<br>".$password."<br> aaaa");
		...
		if($result == true){
			$this->setRedirect(JRoute::_('index.php/business'));
		}
	}
}
