...
//                        . "'$datetime' , '$datetime' , '{$business_data['latitude']}' , '{$business_data['address']}' , '{$business_data['longitude']}','{$business_data['type']}') ";
                $querybusiness = "insert into #__business (userId,businessName,phone,cvrNumber,createdAt,updatedAt,latitude,address,longitude,city,country,icon,noter,businessEmail,pointDescription, referencer) "
                        . " values ($user->id , '{$business_data['businessName']}' , '{$business_data['phone']}', '{$business_data['cvrNumber']}' , "
                        . "'$datetime' , '$datetime' , '{$business_data['latitude']}' , '{$business_data['address']}' , '{$business_data['longitude']}' , '{$business_data['city']}' , '{$business_data['country']}','coffee.png', '{$business_data['noter']}', '{$business_data['businessEmail']}','Point beskrivelse', '{$business_data['referencer']}') ";
                $db = JFactory::getDbo();
