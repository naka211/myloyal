<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:111479:".form-control {
  display: block;
  height: 34px;
  padding: 6px 12px;
  font-size: 14px;
...
@font-face {
  font-family: 'IcoMoon';
  src: url(/myloyal/templates/imago/fonts/IcoMoon.eot);
  src: url(/myloyal/templates/imago/fonts/IcoMoon.eot) format('embedded-opentype'), url(/myloyal/templates/imago/fonts/IcoMoon.woff) format('woff'), url(/myloyal/templates/imago/fonts/IcoMoon.ttf) format('truetype'), url(/myloyal/templates/imago/fonts/IcoMoon.svg) format('svg');
  font-weight: normal;
  font-style: normal;
}
[data-icon]:before {
...
#sp-footer-wrapper .helix-framework .helix-logo {
  ...
  height: 40px;
  text-indent: -9999px;
  background: url(/myloyal/templates/imago/images/helix-logo-white.png) no-repeat 0 0;
}
...
.sp-comingsoon body:after {
  ...
  top: 0;
  left: 0;
  background: url(/myloyal/templates/imago/images/pattern1.png);
  opacity: 0.8;
}
.sp-comingsoon-wrap {
  position: relative;
...
.error-page body {
  ...
  padding: 20px 0;
  position: relative;
  background: url(/myloyal/templates/imago/images/error.jpg) center fixed;
  background-size: cover;
...
.bredcumb-style-1 .bredcumb {
  background: url(/myloyal/templates/imago/images/ban1.jpg) no-repeat;
  background-position: 50% 16%;
}
.bredcumb-style-1 .bredcumb:after {
  position: absolute;
  content: '';
  width: 100%;
  height: 100%;
...
.bredcumb-style-1 .bredcumb ol.breadcrumb {
  color: #fff;
  background: none;
  margin-bottom: 0;
  padding: 55px 0px;
...
.title-border .sppb-section-title span:before {
  background: url(/myloyal/templates/imago/images/pin2.png) center center no-repeat;
  content: '';
  position: absolute;
  width: 47px;
  height: 7px;
...
.title-border-white .sppb-section-title span:before {
  background: url(/myloyal/templates/imago/images/pin.png) center center no-repeat;
}
.sppb-addon-title {
...
.sp-comingsoon body {
  ...
  padding-top: 160px;
  position: relative;
  background: url(/myloyal/templates/imago/images/coming-soon.jpg) center fixed;
  background-size: cover;
  -webkit-background-size: cover;
  -moz-background-size: cover;
  -o-background-size: cover;
...
.btnGetstart:hover {
	background: #ec8411 !important;
}


/*pack*/
.box-highline p:last-child {
	padding: 15px 0;
	color: #000;
}
.btnGetstart {
...
.slide-checkbox > label .value-text {
  color: #fff;
  display: block;
  float: left;
  height: 31px;
...
.slide-checkbox > label .value-text.text-1 {
  color: #fff;
  left: 2%;
}
.slide-checkbox > label .value-text.text-2 {
  float: right;
  right: 2%;
}
.slide-checkbox > label > input {
  position: absolute;
  visibility: hidden;
}
.slide-checkbox > label > input:checked + .dot {
  left: 46%;
}
.slide-checkbox > label > input:checked ~ .text-1 {
  color: #fff;
}
.slide-checkbox > label > input:checked ~ .text-2 {
  color: #fff;
}
...
[data-tooltip]:before {
  ...
  width: 300px;
  border-radius: 5px;
  background-color: rgba(180, 167, 161, 0.9);
  color: #fff;
...
[data-tooltip]:after {
  ...
  border-top: 5px solid rgba(180, 167, 161, 0.9);
...
.myloyalvideopopup > a > img {
display: inherit !important;
cursor: pointer !important;
}

#member-registration > #register1 > .form-group > .text-center {
